    ...
    <footer className="flex select-none font-tiltwrap items-center justify-center flex-col w-full bg-slate-800 h-[40vh]">
      ...
      <div className="py-2 text-gray-400">
        <div className="grid grid-flow-col gap-4">
          <div className="hover:text-blue-500 cursor-pointer px-1">
            <svg
          ...
          <div className="hover:text-red-500 cursor-pointer px-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <div className="hover:text-blue-700 cursor-pointer px-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
